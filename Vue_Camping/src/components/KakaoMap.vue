<template>
  <div class="map_wrap">
    ...
    <div id="menu_wrap" class="bg_white">
      ...
      <!-- <hr> -->
      <ul id="placesList">
        <li v-for="(places, index) of searchResult" @mouseover="mouseOverList($event)" @mouseout="mouseOutList()"
          @click="placeListClick($event)" class="item">
      ...
      <div id="pagination">
        <a href="#" v-for="page of paginations.last" :class="{'on' : isCurrent(page)}"
          @click="clickPage($event)">{{page}}</a>
      </div>
    </div>
  </div>
</template>
...
#menu_wrap::-webkit-scrollbar-button {
  display: none
}
