      ...
      <h2>게시물 등록하기</h2>
        <div class="used-heads">
          <div class="used-pics">
            ...
            <input type="file" class="pic-upload" accept="image/*" required multiple>
        ...
        <div class="used-foot">
          ...
          <div class="submit-area">
              <button class="btn bg-gradient-success btn-md false false w-auto me-2" type="submit">작성 완료</button>
          </div>
        </div>
      </div>
  </div>
